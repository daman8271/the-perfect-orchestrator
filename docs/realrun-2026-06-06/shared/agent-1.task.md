...
## Goal
Inventory every TODO, FIXME, HACK, and XXX comment in /tmp/demo-target. For each: file:line,
...
## Hard constraints
- Read-only: do NOT edit, create, or delete any file in /tmp/demo-target.
- Stay inside /tmp/demo-target.
